...
import { View, Text, TouchableHighlight } from 'components/primitives'
...
export const EntryItem: FC<{ ymd: YMD; userID: string; isLast: boolean }> = observer(
	({ ymd, userID, isLast }) => {
		...
		// return <Spacer height={40} marginVertical={5} backgroundColor={ORANGE} />
